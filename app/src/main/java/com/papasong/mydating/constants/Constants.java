package com.papasong.mydating.constants;
...
public interface Constants {
    ...
    String WEB_SITE = "https://papasong.link/";  //web site url address
    ...
    String BILLING_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA06dhoysip7K1wzb55CS";
    ...
    String API_DOMAIN = "https://papasong.link/";  // url address to which the application sends requests | with back slash "/" at the end | example: https://mysite.com/ | for emulator on localhost: http://10.0.2.2/
